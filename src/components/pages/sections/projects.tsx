...
const tagColors: Record<string, string> = {
    ...
    Solidity: "bg-gray-500/10 text-gray-400 border-gray-500/30",
    "Chai": "bg-yellow-600/10 text-yellow-500 border-yellow-600/30",
    "Ethers.js": "bg-indigo-500/10 text-indigo-500 border-indigo-500/30",
    Web3: "bg-violet-500/10 text-violet-500 border-violet-500/30",
};
