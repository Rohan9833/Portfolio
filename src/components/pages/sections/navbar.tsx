...
export function Navbar() {
    ...
    return (
        <nav className="w-full border-b px-4 py-2.5 md:px-8">
            <div className="flex items-center justify-between gap-4">
                {/* Logo with corner bracket accents */}
                <a
                    href="#home"
                ...
                >
                    ...
                    <Logo className="text-[40px] leading-none" />
                ...
                {/* Desktop Nav with clip-path animated highlight */}
                <div className="bg-background/50 font-mono relative hidden items-center backdrop-blur-sm md:flex">
                    {/* Overlay layer (animated highlight) */}
                    <div
                        ref={overlayRef}
                        ...
                        >
                            {NAV_LINKS.map((x, index) => (
                                <motion.a
                                    ...
                                    className={cn(
                                        "group relative overflow-hidden rounded-lg px-4 py-3 text-sm transition-all duration-200",
                                        x.id === active
                                ...
                                >
                                    ...
                                    <div className="from-foreground/0 via-foreground/5 to-foreground/0 absolute inset-0 -translate-x-full bg-linear-to-r transition-transform duration-700 ease-in-out group-hover:translate-x-full" />
                            ...
                            <div className="grid grid-cols-2 gap-2 px-2 py-1">
                                ...
                                <div className="hover:bg-foreground/5 group flex flex-col items-center gap-1.5 rounded-lg py-2 transition-colors">
                                    <ThemeToggle />
                                    <span className="text-foreground/60 group-hover:text-foreground text-[10px] font-medium">
                                        Theme
                                    </span>
